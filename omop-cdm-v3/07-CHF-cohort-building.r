...
# MAGIC %sql
# MAGIC USE CATALOG hls_omop;
# MAGIC USE SCHEMA cdm_542;
...
targetCohort_Description<-"
patients who are newly diagnosed with chronic congestive heart failure (CCHF)
persons with a condition occurrence record of CCHF or any descendants, indexed at the first diagnosis
who have >1095 days of prior observation before their first diagnosis
and have no Furosemide exposure any time prior to first CCHF diagnosis
target_condition_concept_id=4229440  #Chronic congestive heart failure (disorder)
target_drug_concept_id=1719286       #10 ML Furosemide 10 MG/ML Injection
"
